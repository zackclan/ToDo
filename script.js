...
function render(myProject) {
  ...
  function mapItems(x) {
    ...
    return `<div class="project" id="project${projects.indexOf(x)}">
        ...
        <button type="button" class="btn btn-secondary dropdown-toggle" id="${projects.indexOf(
          x
        )}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Menu
        </button>
        <div class="dropdown-menu">
            <a class="dropdown-item options add" data-toggle="modal" data-target="#exampleModal" data-id=${projects.indexOf(
              x
            )} id="${projects.indexOf(x)}" href="#">Add task</a>
            <a class="dropdown-item options delete" id="${projects.indexOf(
              x
